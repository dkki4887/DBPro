...
public class Header implements MySerializableClass {
    ...
    public final static byte CODE_USER_ID = 0x01; // 타입 0x03 일때는 -> 성공
    public final static byte CODE_USER_PW = 0x02; // 타입 0x03 일때는 -> 실패
    public final static byte CODE_USER_NAME = 0x03; // 타입 0x03 일때는 -> 실패
    public final static byte CODE_USER_ADDRESS = 0x04; // 타입 0x03 일때는 -> 실패
    public final static byte CODE_USER_TYPE = 0x05;
    public final static byte CODE_USER_PHONE = 0x06;

    public final static byte CODE_STORE_NAME = 0x07;
    ...
    public final static byte CODE_STORE_COUNT_OF_SALE = 0x2D;
    public final static byte CODE_STORE_TOTAL_SALES = 0x2E;
    public final static byte CODE_STORE_TIME = 0x2F ;
    ...
    public final static byte F = 0x50;
    public static final byte CODE_USER_DTO = 0x50;
